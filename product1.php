...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="product1.php" class="active" style="color:#111;">Lipsticks</a></li>
				<li>|</li>
				<li><a href="BB-creams1.php">BB-creams</a></li>
				<li>|</li>
				<li><a href="eyeshadow1.php">Eyeshadow</a></li>
			</ul>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='lipsticks' ORDER BY product_id DESC") or die (mysqli_error());
