	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				...
				<li>|</li>
				<li><a href="BB-creams1.php" class="active" style="color:#111;">BB-creams</a></li>
				<li>|</li>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='BBcreams' ORDER BY product_id DESC") or die (mysqli_error());
